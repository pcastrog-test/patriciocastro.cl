...
Dos talleres: **(A) laboratorio** sobre el dataset del curso . No se requiere Python ni herramientas de visualización: se trabaja en papel/planilla y con una IA conversacional (ChatGPT o Claude).

### Taller — Laboratorio: "El primer CLV de tu vida" (≈25 min)
...
### Taller Proyecto: "El negocio de cada uno en una frase" + hipótesis de CLV/CAC (≈30 min)
